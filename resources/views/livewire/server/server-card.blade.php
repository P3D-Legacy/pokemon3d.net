    ...
    <div class="max-w-lg">
        <div class="relative p-4 bg-white rounded-lg shadow-lg dark:bg-black">
            @if(auth()->user()->id == $this->server->user_id)
                <div x-data="{ dropdownOpen: false }" class="absolute top-2 right-2" x-cloak>
                    ...
                    <div x-show="dropdownOpen" @click.away="dropdownOpen = false" class="absolute right-0 z-40 w-48 py-2 mt-2 bg-white border border-gray-200 rounded-md shadow-md dark:bg-gray-900 dark:border-gray-800">
                        ...
                        @endif
                        <a href="{{ route('server.edit', $this->server->id) }}" class="block px-4 py-2 text-sm text-gray-700 capitalize dark:text-gray-300 hover:bg-green-700 hover:text-white">
                            <svg xmlns="http://www.w3.org/2000/svg" class="inline-block w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="relative inline-block">
                <span class="absolute top-0 left-0 inline-block w-3 h-3 {{ ($this->server->ping && $this->server->last_check_at) ? 'bg-green-600' : 'bg-red-600' }} border-2 border-white rounded-full dark:border-gray-600"></span>
                ...
                @if($this->server->official)
                    <div x-data="{ tooltip: false }" class="relative z-30 inline-flex">
                        <span x-on:mouseover="tooltip = true" x-on:mouseleave="tooltip = false" class="inline-flex items-center justify-center px-2 py-1 text-sm font-bold leading-none text-indigo-100 uppercase bg-green-700 rounded"><svg xmlns="http://www.w3.org/2000/svg" class="inline-block w-4 h-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z" /></svg>Official</span>
