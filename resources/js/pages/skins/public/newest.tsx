...
export default function SkinsNewest({ skins }: Props) {
        ...
        <>
            ...
            <div className="py-12">
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div className="mb-6 text-sm text-slate-500 dark:text-slate-400">Skins / Public / Newest</div>

                    <div className="mb-4 flex items-center">
                        <Link
                            href={skinsNewest.url()}
                            className="rounded-l-md border border-r-0 border-slate-300 bg-green-50 px-4 py-2 text-base font-medium text-green-800 dark:border-green-700 dark:bg-green-800 dark:text-green-300"
                        >
                            Newest
                        </Link>
                        <Link
                            href={skinsPopular.url()}
                            className="rounded-r-md border border-slate-300 bg-white px-4 py-2 text-base font-medium text-slate-800 hover:bg-green-50 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-200 dark:hover:bg-slate-600"
                        >
                            Most Popular
                        </Link>
                    </div>
