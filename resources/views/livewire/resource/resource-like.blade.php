<span class="inline-flex items-center justify-center px-2 py-1 mr-2 font-bold leading-none uppercase rounded cursor-pointer {{ ($liked ? 'text-red-50 bg-red-500 dark:bg-red-600' : 'text-gray-600 bg-gray-200 dark:bg-gray-400 dark:text-gray-600') }}" wire:click="like">
    @if($liked)
