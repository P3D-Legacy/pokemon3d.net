...
>
    ...
    <div x-show="show" class="mb-6 bg-white dark:bg-gray-700 text-black dark:text-white rounded-lg overflow-hidden shadow-xl transform transition-all sm:w-full {{ $maxWidth }} sm:mx-auto"
