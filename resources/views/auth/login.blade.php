		...
		@if(\Carbon\Carbon::createFromFormat('Y-m-d', '2022-03-01')->isFuture())
			<div class="px-4 py-3 text-sm leading-normal text-blue-700 bg-blue-100 rounded-lg" role="alert">
				<p>
					...
					This new website has now it's own authentication. Please <a class="font-bold hover:underline" href="{{ env('LOGIN_AUTH_BLOG_POST') ?? route('blog.index') }}">read this blog post</a> for more information!
				</p>
			</div>
