            ...
            @foreach ($posts as $post)
                <tr>
                    ...
                    <td class="px-5 py-5 text-sm bg-white dark:bg-black border-b border-gray-200 dark:border-gray-800">
                        ...
                        <button onclick="Livewire.emit('openModal', 'blog.post-delete', {{ json_encode(['post_id' => $post->id]) }})" class="px-2 py-1 mr-1 text-sm font-semibold text-center text-white transition duration-200 ease-in bg-red-600 rounded-lg shadow-md hover:bg-red-700 focus:ring-red-500 focus:ring-offset-red-200 focus:outline-none focus:ring-2 focus:ring-offset-2">
                            <svg xmlns="http://www.w3.org/2000/svg" class="inline-block w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
