<span class="flex items-center w-full mt-12 text-3xl align-center">
    <button wire:click="like" wire:loading.attr="disabled" class="flex mx-auto {{ $liked ? 'text-green-500 hover:text-green-400' : 'text-gray-400 hover:text-green-300' }} focus:outline-none focus:ring-0 disabled:text-gray-700">
        @if($liked)
