...
class SkinController extends Controller
{
    ...
    public function show($uuid)
    {
        ...
        return view('game.skin.skins.show')->with('skin', $skin);
    }
    ...
    public function newestpublicskins()
    {
        ...
        return view('game.skin.skins.public.newest')->with('skins', $skins);
    }
    ...
    public function popularpublicskins()
    {
        ...
        return view('game.skin.skins.public.popular')->with('skins', $skins);
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('game.skin.skins.create');
    }
    ...
    public function edit(Request $request, $uuid)
    {
        ...
        return view('game.skin.skins.edit')->with('skin', $skin);
    }
