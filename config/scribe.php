...
return [
     ...
     */
    'intro_text' => <<<'INTRO'
This documentation aims to provide all the information you need to work with our API. This API only provides access to the functionality built into the website.
