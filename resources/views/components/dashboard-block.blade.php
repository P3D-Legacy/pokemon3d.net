<div class="p-6 border-b border-slate-200 bg-spring sm:px-20 dark:border-slate-700 dark:bg-slate-900">

    <div class="mt-8 font-mono text-3xl font-bold tracking-tighter text-slate-50">
...
<div class="grid grid-cols-1 bg-slate-200 bg-opacity-25 md:grid-cols-2 dark:bg-slate-800">
    <div class="p-6">
        <div class="flex items-center">
            ...
            <div class="ml-4 text-lg font-semibold leading-7 text-slate-600 dark:text-slate-300">@lang('Documentation')</div>
        </div>
    ...
    <div class="p-6 border-t border-slate-200 md:border-t-0 md:border-l dark:border-slate-900">
        <div class="flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 71 55" class="w-8 h-8 text-slate-400">
            ...
            <div class="ml-4 text-lg font-semibold leading-7 text-slate-600 dark:text-slate-300">Discord</div>
        </div>
    ...
    <div class="p-6 border-t border-slate-200 dark:border-slate-900">
        <div class="flex items-center">
            ...
            <div class="ml-4 text-lg font-semibold leading-7 text-slate-600 dark:text-slate-300">@lang('Custom Skin')</div>
        </div>
    ...
    <div class="p-6 border-t border-slate-200 md:border-l dark:border-slate-900">
        <div class="flex items-center">
            ...
            <div class="ml-4 text-lg font-semibold leading-7 text-slate-600 dark:text-slate-300">@lang('Forum (Archived)')</div>
        </div>
