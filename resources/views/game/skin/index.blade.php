<x-app-layout>
    <x-slot name="header">
        <h2 class="text-xl font-semibold leading-tight text-gray-800">
            Skin <a href="{{ route('skin-create') }}" class="px-2 py-1 ml-4 text-sm font-bold text-white bg-green-500 rounded hover:bg-green-700"><svg xmlns="http://www.w3.org/2000/svg" class="inline-block w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" /></svg> Create</a>
        </h2>
    </x-slot>
                                    ...
                                    @else
                                        ...
                                        @else
                                            <p class="mt-3 text-sm">
                                                <a href="{{ route('import', Auth::user()->gamejolt->id) }}" class="items-center inline-block w-full px-4 py-2 mt-2 text-blue-900 transition-colors duration-150 bg-blue-200 rounded-lg focus:shadow-outline hover:bg-blue-300">
