							...
							@foreach ($posts as $post)
								<tr>
									...
									<td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
										...
										<a href="{{ route('posts.edit', $post) }}" class="py-1 px-2 bg-yellow-600 hover:bg-yellow-700 focus:ring-yellow-500 focus:ring-offset-yellow-200 text-white w-full transition ease-in duration-200 text-center text-sm font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg mr-1">
											<svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 inline-block" fill="none" viewBox="0 0 24 24" stroke="currentColor">
