    ...
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-2">
                                {!! __('I agree to the :terms and :privacy', [
                                        'terms' => '<a target="_blank" href="'.route('terms.show').'" class="text-sm text-gray-600 underline hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-200">'.__('Terms and Conditions').'</a>',
                                        'privacy' => '<a target="_blank" href="'.route('policy.show').'" class="text-sm text-gray-600 underline hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-200">'.__('Privacy Policy').'</a>',
                                ]) !!}
                            </div>
                        </div>
                    </x-jet-label>
            ...
            <div class="flex items-center justify-end mt-4">
                <a class="text-sm text-gray-600 underline hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-200" href="{{ route('login') }}">
