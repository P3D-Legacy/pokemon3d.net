<div class="p-6 bg-white border-b border-gray-200 sm:px-20">
    ...
    <div class="mt-8 font-mono text-3xl font-bold tracking-tighter">
...
<div class="grid grid-cols-1 bg-gray-200 bg-opacity-25 md:grid-cols-2">
    <div class="p-6">
        <div class="flex items-center">
            ...
            <div class="ml-4 text-lg font-semibold leading-7 text-gray-600"><a href="#">Documentation</a></div>
        </div>
        ...
        <div class="ml-12">
            ...
            <a href="https://pokemon3d.net/wiki/">
                <div class="flex items-center mt-3 text-sm font-semibold text-green-700">
    ...
    <div class="p-6 border-t border-gray-200 md:border-t-0 md:border-l">
        <div class="flex items-center">
            ...
            <div class="ml-4 text-lg font-semibold leading-7 text-gray-600"><a href="#">Forum</a></div>
        </div>
    ...
    <div class="p-6 border-t border-gray-200">
        <div class="flex items-center">
            ...
            <div class="ml-4 text-lg font-semibold leading-7 text-gray-600"><a href="#">Custom Skin</a></div>
        </div>
    ...
    <div class="p-6 border-t border-gray-200 md:border-l">
        <div class="flex items-center">
            ...
            <div class="ml-4 text-lg font-semibold leading-7 text-gray-600">Profile</div>
        </div>
