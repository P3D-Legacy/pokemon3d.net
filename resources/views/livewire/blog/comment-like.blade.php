<span class="inline-flex items-center justify-center px-2 py-1 font-bold leading-none uppercase rounded text-xs cursor-pointer {{ ($liked ? 'text-red-500 hover:text-red-400' : 'text-gray-600 dark:text-gray-400 hover:text-red-400') }}" wire:click="like">
    @if($liked)
