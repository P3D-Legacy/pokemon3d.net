<div class="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 grid-flow-cols">
    ...
    <div class="col-span-1 p-4 overflow-hidden text-gray-700 border border-gray-200 rounded-lg shadow-md sm:col-span-2 md:col-span-3 lg:col-span-4 bg-gray-50 dark:bg-gray-900 dark:border-gray-700 dark:text-gray-100">
    ...
    @foreach ($reviews as $review)
        <div class="p-4 overflow-hidden border border-gray-200 rounded-lg shadow-md bg-gray-50 dark:bg-gray-900 dark:text-gray-100 dark:border-gray-700">
