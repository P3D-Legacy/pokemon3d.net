<div class="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 grid-flow-cols">
    ...
    <div class="col-span-1 p-4 overflow-hidden text-slate-700 border border-slate-200 rounded-lg shadow-md sm:col-span-2 md:col-span-3 lg:col-span-4 bg-slate-50 dark:bg-slate-900 dark:border-slate-700 dark:text-slate-100">
    ...
    @foreach ($reviews as $review)
        <div class="p-4 overflow-hidden border border-slate-200 rounded-lg shadow-md bg-slate-50 dark:bg-slate-900 dark:text-slate-100 dark:border-slate-700">
            ...
            <div>
                ...
                <p class="text-slate-700 break-word dark:text-slate-200">
                    {{ $review->review }}
                </p>
            </div>
        </div>
