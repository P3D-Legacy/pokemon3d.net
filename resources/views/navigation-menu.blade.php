            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                ...
                <div class="relative ml-3">
                    <x-jet-dropdown align="right" width="60">
                        <x-slot name="trigger">
                            <span class="inline-flex rounded-md">
                                <button id="switchTheme" class="inline-flex items-center p-2 text-sm font-medium leading-4 text-gray-500 transition bg-white border border-transparent rounded-full hover:bg-gray-50 hover:text-gray-700 dark:text-yellow-500">
