    ...
    <x-jet-form-section submit="save">
        ...
        <x-slot name="form">
            ...
            <div class="col-span-6">
                ...
                <textarea id="description" wire:model.defer="description" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-green-300 focus:ring focus:ring-green-200 focus:ring-opacity-50 dark:bg-black dark:text-white dark:border-gray-900"></textarea>
