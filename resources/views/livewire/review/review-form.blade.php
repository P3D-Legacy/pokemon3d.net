<x-modal>
    ...
    <x-slot name="content">
        ...
        <div class="relative inline-block w-full">
            <select class="w-full h-10 pl-3 pr-6 text-base text-gray-800 placeholder-gray-600 border rounded-lg appearance-none focus:shadow-outline dark:bg-black dark:text-gray-400 dark:border-gray-800" id="gameversion" name="gameversion" wire:model.defer="gameversion">
